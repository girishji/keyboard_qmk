...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        QK_LEADER, OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_RSFT), KC_RIGHT,
        LT(_FN, KC_KB_MUTE), OSM(MOD_LALT), KC_BTN1, MO(_FN), CMD_or_CTRL_W, KC_SPC, KC_GRV, KC_BSPC, KC_PGDN, KC_PGUP, CMD_GRV, OSM(MOD_RALT), KC_LEFT, KC_DOWN
    ),
    [_FN]   = LAYOUT(
